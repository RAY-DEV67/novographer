...
query.get().then((querySnapshot) => {
  ...
  return (
    <div>
        ...
        <form className="relative mt-[1rem]"   onSubmit={() => {
          navigate(`/Search/${newSearch}`);
        }}>
        <input
          type="text"
          placeholder="Search for products, categories..."
          className="border w-[90%] px-[1rem] py-[0.3rem] rounded-[20px] my-[0.5rem] bg-white"
          onChange={(e) => {
      ...
      />
        <svg
          width="35px"
          className="border p-[0.3rem] rounded-[20px] absolute top-[20%] right-[5%] bg-black"
          viewBox="0 0 24 24"
          fill="none"
